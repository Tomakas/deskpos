...
CompanySettingsModel companySettingsFromEntity(CompanySetting e) => CompanySettingsModel(
      ...
      maxItemDiscountPercent: e.maxItemDiscountPercent,
      maxBillDiscountPercent: e.maxBillDiscountPercent,
...
RegisterModel registerFromEntity(Register e) => RegisterModel(
      ...
      allowMealTicket: e.allowMealTicket,
...
ShiftModel shiftFromEntity(Shift e) => ShiftModel(
      ...
      loginAt: e.loginAt,
      logoutAt: e.logoutAt,
      originalLoginAt: e.originalLoginAt,
      originalLogoutAt: e.originalLogoutAt,
      editedBy: e.editedBy,
      editedAt: e.editedAt,
      createdAt: e.createdAt,
      updatedAt: e.updatedAt,
