  ...
  switch (tableName) {
    ...
    case 'shifts':
      return ShiftsCompanion(
        ...
        originalLoginAt: Value(_parseDateTime(json['original_login_at'])),
        originalLogoutAt: Value(_parseDateTime(json['original_logout_at'])),
        editedBy: Value(json['edited_by'] as String?),
        editedAt: Value(_parseDateTime(json['edited_at'])),
        createdAt: Value(_parseDateTime(json['client_created_at']) ?? now),
        updatedAt: Value(_parseDateTime(json['client_updated_at']) ?? now),
        deletedAt: Value(_parseDateTime(json['deleted_at'])),
        serverCreatedAt: Value(_parseDateTime(json['created_at'])),
