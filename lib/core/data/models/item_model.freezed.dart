...
mixin _$ItemModel {
 ...
 String get id; String get companyId; String? get categoryId; String get name; String? get description; ItemType get itemType; String? get sku; int? get unitPrice; String? get saleTaxRateId; bool get isSellable; bool get isActive; UnitType get unit; String? get altSku; int? get purchasePrice; String? get purchaseTaxRateId; bool get isOnSale; bool get isStockTracked; double? get minQuantity; String? get manufacturerId; String? get supplierId; String? get parentId; NegativeStockPolicy? get negativeStockPolicy; PrepArea? get prepArea; String? get color; DateTime get createdAt; DateTime get updatedAt; DateTime? get deletedAt;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,companyId,categoryId,name,description,itemType,sku,unitPrice,saleTaxRateId,isSellable,isActive,unit,altSku,purchasePrice,purchaseTaxRateId,isOnSale,isStockTracked,minQuantity,manufacturerId,supplierId,parentId,negativeStockPolicy,prepArea,color,createdAt,updatedAt,deletedAt]);

@override
String toString() {
  return 'ItemModel(id: $id, companyId: $companyId, categoryId: $categoryId, name: $name, description: $description, itemType: $itemType, sku: $sku, unitPrice: $unitPrice, saleTaxRateId: $saleTaxRateId, isSellable: $isSellable, isActive: $isActive, unit: $unit, altSku: $altSku, purchasePrice: $purchasePrice, purchaseTaxRateId: $purchaseTaxRateId, isOnSale: $isOnSale, isStockTracked: $isStockTracked, minQuantity: $minQuantity, manufacturerId: $manufacturerId, supplierId: $supplierId, parentId: $parentId, negativeStockPolicy: $negativeStockPolicy, prepArea: $prepArea, color: $color, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
}
...
@useResult
$Res call({
 String id, String companyId, String? categoryId, String name, String? description, ItemType itemType, String? sku, int? unitPrice, String? saleTaxRateId, bool isSellable, bool isActive, UnitType unit, String? altSku, int? purchasePrice, String? purchaseTaxRateId, bool isOnSale, bool isStockTracked, double? minQuantity, String? manufacturerId, String? supplierId, String? parentId, NegativeStockPolicy? negativeStockPolicy, PrepArea? prepArea, String? color, DateTime createdAt, DateTime updatedAt, DateTime? deletedAt
});
...
as bool,minQuantity: freezed == minQuantity ? _self.minQuantity : minQuantity // ignore: cast_nullable_to_non_nullable
...
as NegativeStockPolicy?,prepArea: freezed == prepArea ? _self.prepArea : prepArea // ignore: cast_nullable_to_non_nullable
as PrepArea?,color: freezed == color ? _self.color : color // ignore: cast_nullable_to_non_nullable
...
class _ItemModel implements ItemModel {
  const _ItemModel({required this.id, required this.companyId, this.categoryId, required this.name, this.description, required this.itemType, this.sku, this.unitPrice, this.saleTaxRateId, this.isSellable = true, this.isActive = true, required this.unit, this.altSku, this.purchasePrice, this.purchaseTaxRateId, this.isOnSale = true, this.isStockTracked = false, this.minQuantity, this.manufacturerId, this.supplierId, this.parentId, this.negativeStockPolicy, this.prepArea, this.color, required this.createdAt, required this.updatedAt, this.deletedAt});
