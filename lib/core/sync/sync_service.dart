...
class SyncService {
  ...
  TableInfo _getDriftTable(String tableName) => switch (tableName) {
    ...
    'items' => _db.items,
    'modifier_groups' => _db.modifierGroups,
    'modifier_group_items' => _db.modifierGroupItems,
    'item_modifier_groups' => _db.itemModifierGroups,
    ...
    'company_currencies' => _db.companyCurrencies,
    ...
    'order_item_modifiers' => _db.orderItemModifiers,
    'payments' => _db.payments,
    'cash_movements' => _db.cashMovements,
    'session_currency_cash' => _db.sessionCurrencyCash,
    'shifts' => _db.shifts,
