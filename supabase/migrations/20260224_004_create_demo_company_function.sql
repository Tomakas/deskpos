...
-- NOTE: Canonical version is in 20260226_006_retail_demo_templates.sql
--       which adds NULL safety guards, mode-aware schedule lookup,
--       and SET statement_timeout = '300s'.
-- ============================================================================
